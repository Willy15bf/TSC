		...
		\begin{enumerate}
			\item 
				\begin{minipage}[t]{\linewidth}
			          \raggedright
			          \adjustbox{valign=t}{
			            \includegraphics[width=.4\linewidth]{../ss/MIN/instalacion/primera.png}
			          }
			          \medskip
			...
			\item 
				\begin{minipage}[t]{\linewidth}
			          \raggedright
			          \adjustbox{valign=t}{
			            \includegraphics[width=.4\linewidth]{../ss/MIN/instalacion/diskN.png}
			          }
			          \medskip
			...
			\item 				
				\begin{minipage}[t]{\linewidth}
			          \raggedright
			          \adjustbox{valign=t}{
			            \includegraphics[width=.4\linewidth]{../ss/MIN/instalacion/red.png}
			          }
			          \medskip
			...
			\item
				\begin{minipage}[t]{\linewidth}
			          \raggedright
			          \adjustbox{valign=t}{
			            \includegraphics[width=.4\linewidth]{../ss/MIN/instalacion/red2.png}
			          }
			          \medskip
			...
			\item 
				\begin{minipage}[t]{\linewidth}
			          \raggedright
			          \adjustbox{valign=t}{
			            \includegraphics[width=.4\linewidth]{../ss/MIN/instalacion/huso.png}
			          }
			          \medskip
			...
			\item 
				\begin{minipage}[t]{\linewidth}
			          \raggedright
			          \adjustbox{valign=t}{
			            \includegraphics[width=.4\linewidth]{../ss/MIN/instalacion/particion.png}
			          }
			          \medskip
			...
			\item 
				\begin{minipage}[t]{\linewidth}
			        \raggedright
			        \adjustbox{valign=t}{
			        \includegraphics[width=.4\linewidth]{../ss/MIN/instalacion/instalacion.png}
			        }
			        \medskip
		    ...
		    \item 
		    	\begin{minipage}[t]{\linewidth}
			        \raggedright
			        \adjustbox{valign=t}{
			        \includegraphics[width=.4\linewidth]{../ss/MIN/instalacion/fin.png}
			        }
			        \medskip
		   	...
		   	\item 
		   		\begin{minipage}[t]{\linewidth}
			        \raggedright
			        \adjustbox{valign=t}{
			        \includegraphics[width=.4\linewidth]{../ss/MIN/instalacion/uname.png}
			        }
			        \medskip
		    ...
		    \item 
		    	\begin{minipage}[t]{\linewidth}
			        \raggedright
			        \adjustbox{valign=t}{
			        \includegraphics[width=.4\linewidth]{../ss/MIN/instalacion/top.png}
			        }
			        \medskip
		...
		\begin{enumerate}
			\item 
				\begin{minipage}[t]{\linewidth}
			        \raggedright
			        \adjustbox{valign=t}{
			        \includegraphics[width=.4\linewidth]{../ss/FULL/instalacion/boot-menu.png}
			        }
			        \medskip
		    ...
		    \item
		    	\begin{minipage}[t]{\linewidth}
			        \raggedright
			        \adjustbox{valign=t}{
			        \includegraphics[width=.4\linewidth]{../ss/FULL/instalacion/desktop.png}
			        }
			        \medskip
		    ...
		    \item 
		    	\begin{minipage}[t]{\linewidth}
			        \raggedright
			        \adjustbox{valign=t}{
			        \includegraphics[width=.4\linewidth]{../ss/FULL/instalacion/almacenamiento.png}
			        }
			        \medskip
			        \\En caso de contar con dispositivos de almacenamiento especializados como iSCSI, SAN, etc, marcar la segunda opción, sino, la primera es la que se elige. Dar en siguiente. 
		        \end{minipage}	
		    ...
		    \item 
		    	\begin{minipage}[t]{\linewidth}
			        \raggedright
			        \adjustbox{valign=t}{
			        \includegraphics[width=.4\linewidth]{../ss/FULL/instalacion/root-password.png}
			        }
			        \medskip
		    ...
		    \item 
		    	\begin{minipage}[t]{\linewidth}
			        \raggedright
			        \adjustbox{valign=t}{
			        \includegraphics[width=.4\linewidth]{../ss/FULL/instalacion/particion.png}
			        }
			        \medskip
			        \\Proceso de particionado del disco virtual. Elegir usar todo el espacio. Siguiente. 
		        \end{minipage}
		    ...
		    \item 
		    	\begin{minipage}[t]{\linewidth}
			        \raggedright
			        \adjustbox{valign=t}{
			        \includegraphics[width=.4\linewidth]{../ss/FULL/instalacion/instalacion.png}
			        }
			        \medskip
		    ...
		    \item
		    	\begin{minipage}[t]{\linewidth}
			        \raggedright
			        \adjustbox{valign=t}{
			        \includegraphics[width=.4\linewidth]{../ss/FULL/instalacion/setup.png}
			        }
			        \medskip
		    ...
		    \item 
		    	\begin{minipage}[t]{\linewidth}
			        \raggedright
			        \adjustbox{valign=t}{
			        \includegraphics[width=.4\linewidth]{../ss/FULL/instalacion/licencia.png}
			        }
			        \medskip
		    ...
		    \item
		    	\begin{minipage}[t]{\linewidth}
			        \raggedright
			        \adjustbox{valign=t}{
			        \includegraphics[width=.4\linewidth]{../ss/FULL/instalacion/login.png}
			        }
			        \medskip
	        ...
	        \item
	        	\begin{minipage}[t]{\linewidth}
			        \raggedright
			        \adjustbox{valign=t}{
			        \includegraphics[width=.4\linewidth]{../ss/FULL/instalacion/CentOS.png}
			        }
			        \medskip
		    ...
		    \item
	        	\begin{minipage}[t]{\linewidth}
			        \raggedright
			        \adjustbox{valign=t}{
			        \includegraphics[width=.4\linewidth]{../ss/FULL/instalacion/top.png}
			        }
			        \medskip
			        \\Comando top, para visualizar la utilización de recursos del sistema.
		        \end{minipage}
