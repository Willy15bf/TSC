...
\subsubsection{Red NAT}
	...
	Esto significa que el SO invitado, funcionará incluso si el Host se mueve desde una red a otra (como un notebook moviéndose en distintas ubicaciones), y desde conexiones inalámbricas a conexiones cableadas también.
...
\subsubsection{Red bridge}
	...
	\begin{figure}[ht]
	\center
	\includegraphics[width=0.75\linewidth]{../ss/MIN/bridge/bridge-mv-min.png} 
	\end{figure}
